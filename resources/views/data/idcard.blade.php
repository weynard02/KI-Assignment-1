            ...
            <div class="card-body">
                <div class="d-flex flex-column">
                    <div class="form-group mb-3 p-2">
                        ...
                        <input type="hidden" class="form-control" id="realsymkey" value="{{$aesuser->id_card_key}}">
                    ...
                    <form action="{{ route('mail.idcard', ['key' => $user->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div class="form-group mb-2 p-2 d-block visually-hidden" id="hiddendata">
                        ...
                        @php
                            $akey = $aesuser->id_card_key;
                            $akey = str_replace('/', '', $akey);
                        @endphp
                        <a href="/download/aes/id_card/{{$aesuser->id}}/{{$akey}}" class="btn btn-primary btn-sm">Download</a>
                    </div>
                </div>
            </div>
        </div>
